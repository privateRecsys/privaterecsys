...
export const SIMILAR_MOVIES_BY_ID_GET_REQUEST = 'SIMILAR_MOVIES_BY_ID_GET_REQUEST';
export const SIMILAR_MOVIES_BY_ID_GET_SUCCESS = 'SIMILAR_MOVIES_BY_ID_GET_SUCCESS';
export const SIMILAR_MOVIES_BY_ID_GET_FAILURE = 'SIMILAR_MOVIES_BY_ID_GET_FAILURE';

export const MOVIES_GET_REQUEST = 'MOVIES_GET_REQUEST';
export const MOVIES_GET_SUCCESS = 'MOVIES_FEATURED_GET_SUCCESS';
export const MOVIES_GET_FAILURE = 'MOVIES_FEATURED_GET_FAILURE';
